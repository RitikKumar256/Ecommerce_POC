...
import com.Riecommerce.ecommercePOC.request.LoginRequest;
import com.Riecommerce.ecommercePOC.response.AuthResponse;
import com.Riecommerce.ecommercePOC.service.CustomeUserServiceImplementation;
...
@PostMapping("/signup")
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user) throws UserException {
        ...
        authResponse.setMessage("SignupSuccess");
